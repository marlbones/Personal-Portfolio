  ...
  <div className={classes.wrapper}>
    <div className={classes.container}>
      <div className={classes.info}>
        ...
        <p className={classes.sub}>My current stack of choice is <strong>Html</strong>, <strong>CSS</strong>, <strong>Javascript</strong>, <strong>React</strong>, <strong>React Native</strong>, <strong>Node.js</strong>, <strong>Apollo</strong> and <strong>GraphQL</strong>; however I love experimenting and learning new things.</p>
