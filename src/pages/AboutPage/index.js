  ...
  <div className={classes.wrapper}>
    <div className={classes.container}>
      ...
      <p className = {classes.sub}>Hi there.</p>
        ...
        <p className={classes.sub}>Having previously worked as a social worker for about 7 years, I finally gave in to the call of the tech world and changed careers.</p>
